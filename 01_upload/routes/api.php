...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    Route::get('advert-search', [AdvertController::class, 'search']);
    ...
    Route::get('/place-by-province-guide', [PlaceController::class, 'indexProvinceGuide']);
    Route::get('/place-city-guide', [PlaceController::class, 'indexCityGuide']);
    Route::get('/place-by-city-guide', [PlaceController::class, 'indexCityGuide']);
    /* PLACE-IMAGE */
